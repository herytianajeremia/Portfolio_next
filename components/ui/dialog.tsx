...
>(({ className, children, hideClose = false, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {!hideClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 text-muted-foreground opacity-80 ring-offset-background transition hover:bg-foreground/10 hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:pointer-events-none">
          <X className="h-4 w-4" />
