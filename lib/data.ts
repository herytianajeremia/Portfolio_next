...
export const projects: Project[] = [
  ...
  },
  {
    ...
    desc: {
      ...
      en: "Full Figma mockup of the Meb Studio website.",
    },
  },
   {
    id: "design_web",
  ...
  },
   {
    ...
    name: "Web Design",
    category: "design",
    image: "/img/img-projet/sorea.png",
    url: "https://sorea.mg/",
    tags: ["Figma", "Web Design"],
    desc: {
      fr: "Maquette Figma complète du site Meb Studio.",
  ...
  },
  {
    ...
    name: "Application mobile",
    category: "design",
    image: "/img/img-projet/appbefiana.png",
    url: "https://www.figma.com/proto/q6nndM1gE82KQvBeyyEvPn/Befiana?node-id=377-3532&t=8IpKlc8sfECu5MfV-0&scaling=scale-down&content-scaling=fixed&page-id=326%3A3551&starting-point-node-id=377%3A3062&show-proto-sidebar=1",
    tags: ["Figma", "Mobile"],
    desc: {
      fr: "Concept d'interface pour une application mobile.",
      en: "Interface concept for a mobile application.",
  ...
  },
  {
    ...
    name: "Application mobile",
    category: "design",
    image: "/img/img-projet/app1.png",
    url: "https://www.figma.com/proto/LYJtzG3tHvxC6DwrVwP2k5/Tutoriel?node-id=111-66&t=4VxKYNL7HFlZ2fHX-0&scaling=scale-down&content-scaling=fixed&page-id=12%3A4&starting-point-node-id=96%3A292&show-proto-sidebar=1",
    tags: ["Figma", "Social"],
    desc: {
      fr: "Concept d'interface pour une application mobile.",
      en: "Interface concept for a mobile application.",
  ...
  },
  {
  ...
  },
   {
    ...
    name: "Identité de marque",
    category: "design",
    image: "/img/img-projet/oxygene.png",
    url: "https://ox6gene.ch/",
    tags: ["Figma", "Branding"],
    desc: {
      fr: "Exploration d'identité visuelle et de composants.",
      en: "Visual identity and component exploration.",
  ...
  },
  {
    ...
    name: "Identité de marque",
    category: "design",
    image: "/img/img-projet/ADC.png",
    url: "https://tibetansoundinstitute.com/fr/",
    tags: ["Figma", "Branding"],
    desc: {
      fr: "Exploration d'identité visuelle et de composants.",
      en: "Visual identity and component exploration.",
